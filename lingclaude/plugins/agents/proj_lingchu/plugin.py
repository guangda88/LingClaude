...
账本对账：org_member/lingchu.json 的 trust/plug 声明与 manifest 一致（测试锚定）。
"""
...
class ProjLingchuPlugin(McpAgentPluginBase):
    """proj/lingchu 灵触插片（absent 型，manifest 全驱动）。"""
...
def register(registry) -> None:
    ...
    registry.register(SeamType.AGENT, ProjLingchuPlugin.name, ProjLingchuPlugin())
