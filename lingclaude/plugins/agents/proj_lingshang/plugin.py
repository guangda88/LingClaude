...
账本对账：org_member/lingshang.json 的 trust/plug 声明与 manifest 一致（测试锚定）。
"""
...
class ProjLingshangPlugin(McpAgentPluginBase):
    """proj/lingshang 灵商插片（absent 型，manifest 全驱动）。"""
...
def register(registry) -> None:
    ...
    registry.register(SeamType.AGENT, ProjLingshangPlugin.name, ProjLingshangPlugin())
