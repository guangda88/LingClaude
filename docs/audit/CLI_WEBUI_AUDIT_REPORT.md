...
> 由 `scripts/update_audit_ledger.py` 于 2026-09-09 15:51 生成。手写 ✅ 已废除（H17）：账目与仪表盘冲突时，以仪表盘为准。

| 检查 | 命令 | 退出码 | 结果摘要 | 耗时 |
|---|---|---|---|---|
| ✅ doc_consistency | `/usr/bin/python scripts/doc_consistency_check.py` | 0 | [09/09/26 15:51:06] INFO     灵知 FactVerifier 可用, 已加载   fact_checker.py:36 | 2.2s |
