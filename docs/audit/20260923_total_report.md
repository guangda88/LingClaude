...
**版本**：v1.2（2026-09-23，第三批整改落地）
**版本史**：
- v1.2 第三批（P1 #6 + P3 落地）：J4 真实违例 2→0（governance_v2 / memory_engine 迁 StateStore，G10c 守卫盲区补齐）；M4 套件级换域升格落地（synthetic_registry 子进程模型 + CI 接入）；详见 `arch_review/review-20260923-batch3-j4-m4`
- v1.1 第二批（P0 全清）：N5 契约漂移守卫 / N1 周期对账绑 N5 / M6 双口径入 CI
- v1.0 本报告（三方综合 + P0/P1/P3 排期）
