...
const zh = {
  ...
  'delete.failed': '删除会话失败，请查看 LingClaude 日志了解详情。',
  ...
  'attach.skillsEmpty': '暂无可用技能。在项目 .lingclaude/skills/<名称>/SKILL.md 添加技能，或放到 ~/.lingclaude/skills/ 全局共享。',
...
const en: Record<MsgKey, string> = {
  ...
  'delete.failed': 'Failed to delete the session. Check the LingClaude logs for details.',
  ...
  'attach.skillsEmpty': 'No skills yet. Add one at .lingclaude/skills/<name>/SKILL.md, or ~/.lingclaude/skills/ to share globally.',
